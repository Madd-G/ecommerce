...
class WaybillFailedResponseModel {
  ...
  factory WaybillFailedResponseModel.fromJson(String str) =>
      WaybillFailedResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory WaybillFailedResponseModel.fromMap(Map<String, dynamic> json) =>
      WaybillFailedResponseModel(
