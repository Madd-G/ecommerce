...
class BuyerOrderItem {
  ...
  factory BuyerOrderItem.fromJson(String str) => BuyerOrderItem.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory BuyerOrderItem.fromMap(Map<String, dynamic> json) => BuyerOrderItem(
        id: json["id"],
